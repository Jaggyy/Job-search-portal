...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/states-create-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="state" type="text" class="form-control rounded30" name="state" required autocomplete>
											</div>
									  	</div>
									</div>
									<!-- /.box-body -->
