...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/states-update-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
							...
							<div class="d-inline-block align-items-center">
								<nav>
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item" aria-current="page"><a href="<?php echo $path; ?>/admin/states/manage">States</a></li>
				...
				<section class="content">
					<div class="row">
						<div class="col-12">
							<div class="box">
								<?php
								$sql_retrieve = "SELECT * FROM states WHERE id = :id";
									...
									<div class="box-body">
									  	...
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="state" type="text" class="form-control rounded30" name="state" value="<?php echo $query_fetch['state']; ?>" required>
											</div>
									  	</div>
									</div>
									<!-- /.box-body -->
