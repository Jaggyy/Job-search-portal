...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/industries-create-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Add Industry</h3>
				...
				<section class="content">
					<div class="row">
						<div class="col-12">
							<div class="box">
								<!-- /.box-header -->
								<form id="content_form" class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	<label class="form-label">Industry</label>
											  	<input id="industry" type="text" class="form-control rounded30" name="industry" required autocomplete>
											</div>
									  	</div>
									  	<div class="col-md-12">
											<div class="form-group">
											  	<label class="form-label">Icon</label>
											  	<input type="file" class="form-control rounded30" name="icon" id="icon" required>
											</div>
									  	</div>
									  	<div class="col-md-12">
									  		<div class="form-group">
