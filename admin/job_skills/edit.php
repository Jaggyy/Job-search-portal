...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/job_skills-update-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Edit Job Skill</h3>
							<div class="d-inline-block align-items-center">
								<nav>
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Edit Job Skill</li>
									</ol>
								</nav>
							</div>
						</div>
				...
				<section class="content">
					<div class="row">
						<div class="col-12">
							<div class="box">
								<?php
								$sql_retrieve = "SELECT * FROM job_skills WHERE id = :id";
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="job_skill" type="text" class="form-control rounded30" name="job_skill" value="<?php echo $query_fetch['job_skill']; ?>" required>
											</div>
									  	</div>
									  	<div class="col-md-12">
									  		<div class="form-group">
