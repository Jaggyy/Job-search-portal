...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/job_skills-create-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Add Job Skill</h3>
							<div class="d-inline-block align-items-center">
								<nav>
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="<?php echo $path; ?>/admin/dashboard"><i class="mdi mdi-home-outline"></i></a></li>
										<li class="breadcrumb-item" aria-current="page"><a href="<?php echo $path; ?>/admin/job_skills/manage">Job Skills</a></li>
										<li class="breadcrumb-item active" aria-current="page">Add Job Skill</li>
									</ol>
								</nav>
							</div>
						</div>
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="job_skill" type="text" class="form-control rounded30" name="job_skill" required autocomplete>
											</div>
									  	</div>
									  	<div class="col-md-12">
									  		<div class="form-group">
