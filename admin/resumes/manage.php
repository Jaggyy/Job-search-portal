...
if(isset($_GET['del']))
{
	...
	if($delete->execute())
	{
		...
		header('Refresh:2;url='.$path.'/admin/resumes/manage');
	}
	else
	{
...
<head>
    ...
    <title>All Resumes | Naukri</title>
	<!-- Vendors Style-->
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Resumes</h3>
								...
								<div class="box-body">
									<div class="table-responsive">
						  				<table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
											<?php
											$sql_retrieve = "SELECT * FROM candidates ORDER BY firstname";
						                    ...
						                    if($query->rowCount() > 0)
						                    {
						                        ...
						                        {
						                        	if($query_fetch->resume != '')
						                        	{
							                        	echo '
														<tr>
															<td>'.$query_fetch->firstname.' '.$query_fetch->lastname.'</td>
															<td class="text-center"><a href="'.$path.'/includes/resume-download?file_id='.$query_fetch->id.'"><span class="badge badge-pill badge-primary">Download</span></a></td>
															<td>
																<a class="btn fix-gr-bg" href="#delete'.$query_fetch->id.'" data-toggle="modal" data-target="#deleteResume'.$query_fetch->id.'"><i class="mdi mdi-delete"></i></a>
															</td>
														</tr>
														<!--Modal-->
														<div class="modal fade" id="deleteResume'.$query_fetch->id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
														aria-hidden="true">
															<div class="modal-dialog modal-dialog-centered" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		...
																		<a class="btn fix-gr-bg" href="'.$path.'/admin/resumes/manage?id='.$query_fetch->id.'&del=delete">Delete</a>
															  		</div>
																</div>
															</div>
														</div>';
