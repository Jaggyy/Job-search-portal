...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/functional_areas-create-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Add Functional Area</h3>
							<div class="d-inline-block align-items-center">
								<nav>
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Add Functional Area</li>
									</ol>
								</nav>
							</div>
						</div>
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="functional_area" type="text" class="form-control rounded30" name="functional_area" required autocomplete>
											</div>
									  	</div>
									  	<div class="col-md-12">
									  		<div class="form-group">
