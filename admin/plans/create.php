...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/plans-create-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">	
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Add Subscription Plan</h3>
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="plan" type="text" class="form-control rounded30" name="plan" required>
											</div>
									  	</div>
									  	<div class="col-md-12">
											<div class="form-group">
											  	<label class="form-label">Allowed Jobs</label>
											  	<input id="allowed_jobs" type="number" class="form-control rounded30" name="allowed_jobs" required>
											</div>
									  	</div>
									  	<div class="col-md-12">
											<div class="form-group">
											  	<label class="form-label">Amount (In Rupees)</label>
											  	<input type="number" name="amount" id="amount" class="form-control rounded30" required>
											</div>
									  	</div>
									</div>
									<!-- /.box-body -->
    ...
    <script src="<?php echo $path; ?>/admin/assets/js/pages/validation.js"></script>
    <script src="<?php echo $path; ?>/admin/assets/js/pages/form-validation.js"></script>
