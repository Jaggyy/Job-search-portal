...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/qualifications-update-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Edit Qualification</h3>
							<div class="d-inline-block align-items-center">
								<nav>
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Edit Qualification</li>
									</ol>
								</nav>
							</div>
						</div>
				...
				<section class="content">
					<div class="row">
						<div class="col-12">
							<div class="box">
								<?php
								$sql_retrieve = "SELECT * FROM qualifications WHERE id = :id";
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="qualification" type="text" class="form-control rounded30" name="qualification" value="<?php echo $query_fetch['qualification']; ?>" required>
											</div>
									  	</div>
									  	<div class="col-md-12">
											<div class="form-group">
											  	<label class="form-label">Short Form</label>
											  	<input id="abbreviation" type="text" class="form-control rounded30" name="abbreviation" value="<?php echo $query_fetch['abbreviation']; ?>" required>
											</div>
									  	</div>
									  	<div class="col-md-12">
									  		<div class="form-group">
