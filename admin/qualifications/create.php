...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/qualifications-create-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
							...
							<div class="d-inline-block align-items-center">
								<nav>
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item" aria-current="page"><a href="<?php echo $path; ?>/admin/qualifications/manage">Qualifications</a></li>
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	<label class="form-label">Qualifiction</label>
											  	<input id="qualification" type="text" class="form-control rounded30" name="qualification" required autocomplete>
											</div>
									  	</div>
									  	<div class="col-md-12">
											<div class="form-group">
											  	<label class="form-label">Short Form</label>
											  	<input id="abbreviation" type="text" class="form-control rounded30" name="abbreviation" required autocomplete>
											</div>
									  	</div>
									  	<div class="col-md-12">
									  		<div class="form-group">
												...
												<div class="c-inputs-stacked">
													<input name="status" type="radio" id="active" class="with-gap radio-col-success" value="1" checked="checked">
												  	<label class="me-30" for="active">Active</label>
												  	<input name="status" type="radio" id="inactive" class="with-gap radio-col-danger" value="0">
