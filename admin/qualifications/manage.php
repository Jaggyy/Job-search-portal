...
if(isset($_GET['del']))
{
	...
	if($delete->execute())
	{
		...
		header('Refresh:2;url='.$path.'/admin/qualifications/manage');
	}
	else
	{
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Qualifications</h3>
						...
						<div class="col-auto text-end float-end ml-auto">
							<a href="<?php echo $path; ?>/admin/qualifications/create" class="btn fix-gr-bg btn-rounded"><i class="mdi mdi-plus"></i>&nbsp;&nbsp;Add New Qualification</a>
						</div>
					</div>
				</div>
				<!-- Main content -->
								...
								<div class="box-body">
									<div class="table-responsive">
						  				<table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
											<?php
											$sql_retrieve = "SELECT * FROM qualifications ORDER BY qualification";
						                    ...
						                    if($query->rowCount() > 0)
						                    {
						                        foreach($results as $query_fetch)
						                        {
													...
													<tr>
														...
														<td>'.$query_fetch->qualification.'</td>
														<td>'.$query_fetch->abbreviation.'</td>';
														?>
														<td>
															<div class="switch">
		                                                        <label>
														...
														<td>
															<div class="btn-group">
															  	...
															  	<div class="dropdown-menu dropdown-menu-end" style="margin: 0px;">
																	<a class="dropdown-item" href="'.$path.'/admin/qualifications/edit?id='.$query_fetch->id.'">EDIT</a>
																	<a class="dropdown-item" href="#delete'.$query_fetch->id.'" data-toggle="modal" data-target="#deleteQualification'.$query_fetch->id.'">DELETE</a>
															  	</div>
															</div>
														</td>
													</tr>
													<!--Modal-->
													<div class="modal fade" id="deleteQualification'.$query_fetch->id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
													aria-hidden="true">
														<div class="modal-dialog modal-dialog-centered" role="document">
															<div class="modal-content">
																<div class="modal-header bg-danger">
																	<h5 class="modal-title" id="exampleModalLongTitle">DELETE QUALIFICATION</h5>
																...
																<div class="modal-footer">
																	...
																	<a class="btn fix-gr-bg" href="'.$path.'/admin/qualifications/manage?id='.$query_fetch->id.'&del=delete">Delete</a>
														  		</div>
															</div>
														</div>
													</div>';
