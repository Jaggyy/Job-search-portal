...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/job_types-update-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Edit Job Type</h3>
				...
				<section class="content">
					<div class="row">
						<div class="col-12">
							<div class="box">
								<?php
								$sql_retrieve = "SELECT * FROM job_types WHERE id = :id";
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="job_type" type="text" class="form-control rounded30" name="job_type" value="<?php echo $query_fetch['job_type']; ?>" required>
											</div>
									  	</div>
									  	<div class="col-md-12">
									  		<div class="form-group">
