...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/admin/includes/job_experiences-create-script.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
		  	...
		  	<div class="container-full">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="me-auto">
							<h3 class="page-title">Add Job Experience</h3>
									...
									<div class="box-body">
									  	<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<input id="job_experience" type="text" class="form-control rounded30" name="job_experience" required autocomplete>
											</div>
									  	</div>
									</div>
									<!-- /.box-body -->
