...
if(isset($_GET['del']))
{
	...
	if($delete->execute())
	{
		...
		header('Refresh:2;url='.$path.'/admin/jobs/pending');
	}
	else
	{
								...
								<div class="box-body">
									<div class="table-responsive">
						  				<table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
											<?php
											$sql_retrieve = "SELECT * FROM jobs WHERE status is null AND (job_expiry_date > CURDATE()) ORDER BY job_title";
														...
														<div class="modal-dialog modal-dialog-centered" role="document">
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<a class="btn fix-gr-bg" href="'.$path.'/admin/jobs/pending?id='.$query_fetch->id.'&del=delete">Delete</a>
														  		</div>
															</div>
														</div>
													</div>';
