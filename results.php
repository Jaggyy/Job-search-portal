...
<script>
    $(document).ready(function() {
        ...
        function filter_data() {
            ...
            $.ajax({
                url: "fetch_results.php?term=<?php echo $term; ?>&state_id=<?php echo $state_id; ?>&city_id=<?php echo $city_id; ?>",
                method: "POST",
                data: {
                    action: action,
                    states: states,
