<header class="stick-top forsticky">
	<div class="menu-sec">
		<div class="container">
			<div class="logo">
				<a href="<?php echo $path; ?>" title=""><img class="hidesticky" src="<?php echo $path; ?>/assets/images/naukri-logo.png" alt="" style="width: 178px;height: 40px;" /><img class="showsticky" src="<?php echo $path; ?>/assets/images/naukri-logo.png" alt="" style="width: 178px;height: 40px;" /></a>
			</div><!-- Logo -->
