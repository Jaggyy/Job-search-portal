				...
				<div class="col-lg-12 column">
					 ...
					 <div class="job-list-modern">
					 	<div class="job-listings-sec no-border">
						 	<div class="row">
							 	<?php
								$retrieve = "SELECT * FROM industries WHERE status = 1 ORDER BY industry";
								...
								if($qery->rowCount() > 0)
								{
									foreach($results as $fetch)
									{
										echo '
										<div class="col-md-3">
											<p class="fetch-list"><a href="'.$path.'/search/industry?name='.$fetch->slug.'">'.$fetch->industry.'</a></p>
										</div>';
									}
								}
								?>
