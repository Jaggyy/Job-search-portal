...
<head>
	...
	<title>Search Jobs By Skill | Naukri</title>
				...
				<div class="col-lg-12 column">
					 ...
					 <div class="job-list-modern">
					 	<div class="job-listings-sec no-border">
					 		<div class="row">
							 	<?php
								$retrieve = "SELECT * FROM job_skills WHERE status = 1 ORDER BY job_skill";
								...
								if($qery->rowCount() > 0)
								{
									foreach($results as $fetch)
									{
										echo '
										<div class="col-md-3">
											<p class="fetch-list"><a href="'.$path.'/search/skill?name='.$fetch->slug.'">'.$fetch->job_skill.'</a></p>
										</div>';
									}
								}
								?>
