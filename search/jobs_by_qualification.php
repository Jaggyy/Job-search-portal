			...
			<div class="container">
				<div class="col-lg-12 column">
			 		<div class="modrn-joblist np">
				 		<div class="filterbar">
				 			<h5>Browse Jobs By Qualification</h5>
				 		</div>
					 </div><!-- MOdern Job LIst -->
					 <div class="job-list-modern">
					 	<div class="job-listings-sec no-border">
						 	<div class="row">
							 	<?php
								$retrieve = "SELECT * FROM qualifications WHERE status = 1 ORDER BY qualification";
								...
								if($qery->rowCount() > 0)
								{
									foreach($results as $fetch)
									{
										echo '
										<div class="col-md-3">
											<p class="fetch-list"><a href="'.$path.'/search/qualification?name='.$fetch->slug.'">'.$fetch->qualification.'</a></p>
										</div>';
									}
								}
								?>
