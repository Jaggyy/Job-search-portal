...
if (isset($_POST["action"])) 
{
    ...
    $sql = "SELECT job_skills.*, manage_job_skills.job_id, manage_job_skills.job_skill_id FROM job_skills LEFT JOIN manage_job_skills ON job_skills.id = manage_job_skills.job_skill_id WHERE job_skills.slug = :name AND job_skills.status = '1'";
