...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/candidate/includes/candidate-register-script.php'); ?>
<!DOCTYPE html>
<html>
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Register Free To Upload Resume And Apply Jobs | Naukri</title>
                    ...
                    <div class="col-lg-9">
                        <div class="account-popup-area signup-popup-box static pt-3" style="border-radius: 5px;">
                            <div class="account-popup pb-3 mb-4">
                                <h3 class="text-center font-weight-bold mb-3" style="border-bottom: 1px solid #d2caca;padding-bottom: 1rem;">
                                ...
                                <form id="register_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
		                            ...
		                            <div class="row">
		                                <div class="col-md-6">
		                                	...
		                                	<div class="cfield" style="border: none;">
												<select name="gender" id="gender" class="chosen" required>
		                            ...
		                            <div class="row">
                                		<div class="col-md-6">
		                                	...
		                                	<div class="cfield" style="border: none;">
					 							<select name="job_experience_id" id="job_experience_id" class="chosen" required style="display: none;">
		                                ...
		                                <div class="col-md-6">
		                                    <label>Role/Function <span class="required">*</span></label>
		                                	<div class="cfield" style="border: none;">
					 							<select name="functional_area_id" id="functional_area_id" class="chosen" required style="display: none;">
		                            ...
		                            <div class="row">
                                		<div class="col-md-6">
		                                	...
		                                	<div class="cfield">
												<input type="file" name="resume" id="resume" required style="display: none;" />
					 							<label class="label_file" for="resume">Upload Resume</label>
		                                ...
		                                <div class="col-md-6">
		                                	...
		                                	<div class="cfield">
		                                		<input type="file" name="photo" id="photo" required style="display: none;" />
					 							<label class="label_file" for="photo">Upload Profile Picture</label>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                    	if(data.message)
                    	{
                            ...
                            setTimeout(function() {
                                window.location.href = "<?php echo $path; ?>/candidate";
                            }, 5000);
                    	}
                    	else if(data.error)
                    	{
