...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/employer/includes/payment-script.php'); ?>
<?php
							...
							<div class="d-inline-block align-items-center">
								<nav>
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="<?php echo $path; ?>/employer/subscriptions/manage">jobs</a></li>
												...
												<div class="row">
													<div class="col-lg-7 col-md-6 col-12">
														<form method="post" action="">
															...
															<input type="hidden" name="amount" value="<?php echo $query_fetch['job_amount']; ?>">
															...
															<button type="submit" name="submit" class="btn btn-success submit">
															  	Pay Rs. <?php echo $query_fetch['job_amount']; ?>
															</button>
														</form>
													</div>
