<header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<!-- Logo -->
		<a href="<?php echo $path; ?>/employer/dashboard" class="logo">
		  	<!-- logo-->
		  	<div class="logo-lg">
        	...
        	<ul class="nav navbar-nav">	
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu animated flipInX">
						<li class="user-body">
							<a class="dropdown-item" href="<?php echo $path; ?>/employer/profile"><i class="ti-user text-muted me-2"></i> Profile</a>
							<a class="dropdown-item" href="<?php echo $path; ?>/employer/change-password"><i class="ti-lock text-muted me-2"></i> Change Password</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo $path; ?>/employer/includes/logout"><i class="ti-lock text-muted me-2"></i> Logout</a>
						</li>
					</ul>
				</li>	
        	</ul>
