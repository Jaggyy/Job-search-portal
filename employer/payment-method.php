...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/employer/includes/featured-update-script.php'); ?>
<?php
												...
												<div class="row">
													<div class="col-lg-7 col-md-6 col-12">
														<form method="post" action="">
															...
															<input type="hidden" name="amount" value="<?php echo $query_fetch['company_amount']; ?>">
															...
															<button type="submit" name="submit" class="btn btn-success submit">
															  	Pay Rs. <?php echo $query_fetch['company_amount']; ?>
															</button>
														</form>
													</div>
