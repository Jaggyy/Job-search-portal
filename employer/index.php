...
?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/naukri/employer/includes/company-login-script.php'); ?>
<!DOCTYPE html>
<html>
<head>
								...
								<div class="col-lg-6">
			                        <div class="account-popup-area signup-popup-box static pt-3">
			                            ...
			                            <div class="account-popup p-0 mb-4">
			                                <span>New User? <a href="<?php echo $path; ?>/employer/register">Sign Up</a></span>
			                            </div>
			                        </div><!-- SIGNUP POPUP -->
			                    </div>
							</div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                    	if(data.message)
                    	{
                            ...
                            setTimeout(function() {
                                window.location.href = "<?php echo $path; ?>/employer/dashboard";
                            }, 5000);
                    	}
                    	else if(data.error)
                    	{
